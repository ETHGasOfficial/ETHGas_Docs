...
| Contract Address |
|------------------|
| <code className="contract-address">`0x104Ef4192a97E0A93aBe8893c8A2d2484DFCBAF1`</code> |
...
| Contract Address |
|------------------|
| <code className="contract-address">`0x3314Fb492a5d205A601f2A0521fAFbD039502Fc3`</code> |
...
| Region | Endpoint |
|--------|----------|
| **Hoodi** | <code className="relay-endpoint">`https://0xb20c3fe59db9c3655088839ef3d972878d182eb745afd8abb1dd2abf6c14f93cd5934ed4446a5fe1ba039e2bc0cf1011@hoodi-relay.ethgas.com`</code> |
...
| Region | Endpoint |
|--------|----------|
| **Tokyo** | <code className="relay-endpoint">`https://0x88ef3061f598101ca713d556cf757763d9be93d33c3092d3ab6334a36855b6b4a4020528dd533a62d25ea6648251e62e@ap-relay.ethgas.com`</code> |
| **Frankfurt** | <code className="relay-endpoint">`https://0x88ef3061f598101ca713d556cf757763d9be93d33c3092d3ab6334a36855b6b4a4020528dd533a62d25ea6648251e62e@eu-relay.ethgas.com`</code> |
| **Virginia** | <code className="relay-endpoint">`https://0x88ef3061f598101ca713d556cf757763d9be93d33c3092d3ab6334a36855b6b4a4020528dd533a62d25ea6648251e62e@us-relay.ethgas.com`</code> |
...
**MainNet Deposit**:
- **Contract**: `0x3314Fb492a5d205A601f2A0521fAFbD039502Fc3`
...
**TestNet Deposit**:
- **Contract**: `0x104Ef4192a97E0A93aBe8893c8A2d2484DFCBAF1`
- **Method**: Deposit via [ETHGas Dashboard](https://app.ethgas.com/my-portfolio/accounts)
...
- **[ETHGas Github](https://github.com/ethgas-developer)** - All source code and tools

## Distributed Validator Integrations

**SSV Validators**
- **Purpose**: Operate validators through SSV Network distributed infrastructure
- **Accounts**: Requires at least one registered SSV operator in ETHGas
- **API quick links**: [SSV Validator APIs](/docs/api/validator/ssv)

**Obol Validators**
- **Purpose**: Run distributed validators via Obol’s DVT integration
- **Accounts**: Requires at least one registered Obol operator in ETHGas
- **API quick links**: [Obol Validator APIs](/docs/api/validator/obol)
...
<div className="status-flow-container">
  <div className="status-item status-pending">pending</div>
  <div className="status-arrow">→</div>
  <div className="status-item status-registered">registered</div>
  <div className="status-arrow">→</div>
  <div className="status-item status-active">active</div>
  <div className="status-arrow">→</div>
  <div className="status-item status-suspended">suspended</div>
  <div className="status-arrow">→</div>
  <div className="status-item status-deregistered">deregistered</div>
</div>
